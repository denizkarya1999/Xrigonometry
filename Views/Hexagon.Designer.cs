...
namespace Xrigonometry.Views
{
    partial class Hexagon : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            generateObjectGroupBox.Size = new Size(186, 237);
            ...
            // 
            generateObjectButton.Location = new Point(34, 186);
            ...
            // nameTextBox
            // 
            nameTextBox.Location = new Point(15, 44);
            ...
            // sideATextBox
            // 
            sideATextBox.Location = new Point(15, 97);
            ...
            sideALabel.Location = new Point(15, 73);
            ...
            // lengthTextBox
            // 
            lengthTextBox.Location = new Point(15, 153);
            ...
            lengthLabel.Location = new Point(15, 129);
            ...
            groupBox1.Size = new Size(305, 237);
            ...
            areaLabel.Location = new Point(41, 175);
            ...
            perimeterLabel.Location = new Point(41, 119);
            ...
            label6.Location = new Point(41, 98);
            label6.Name = "label6";
            ...
            objectNameLabel.Location = new Point(41, 66);
        ...
        private void generateObjectButton_Click(object sender, EventArgs e)
        {
            try
            {
                string hexagonName = nameTextBox.Text;
                double sideA = Convert.ToDouble(sideATextBox.Text);
                double length = Convert.ToDouble(lengthTextBox.Text);

                objects.Hexagon hexagon = new objects.Hexagon(hexagonName, "Hexagon", sideA, length);

                objectNameLabel.Text = hexagon.getName();
                perimeterLabel.Text = hexagon.Perimeter().ToString();
                areaLabel.Text = hexagon.Area().ToString();
            }
            catch (FormatException)
            {
                MessageBox.Show("Please enter valid numeric values for side length and length.");
            }
            catch (Exception ex)
            {
